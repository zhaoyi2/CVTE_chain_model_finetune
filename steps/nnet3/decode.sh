...
online_cmvn=true # Set to 'true' to replace 'apply-cmvn' by 'apply-cmvn-online' in the nnet3 input.
...
if ! $online_cmvn; then
  ...
  feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:- ark:- |"
else
