...
echo "Prepare FST we search to make speech/silence decisions."
###############################################################################
...
echo "Do Viterbi decoding to create per-frame alignments."
###############################################################################
...
echo "Post-process segmentation to create kaldi data directory."
###############################################################################
